...
class OpenPicoKeysApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        source_frame = ttk.LabelFrame(root, text="Step 1 - Pico FIDO Source")
        ...
        profile_frame = ttk.LabelFrame(root, text="Step 2 - Device Customization")
        profile_frame.grid(row=3, column=0, sticky="ew", pady=(12, 0))
        for col in range(4):
        ...
        logs_frame = ttk.LabelFrame(root, text="Step 3 - Build Logs")
    ...
    def _drain_events(self) -> None:
        while True:
            ...
            if kind == "log":
                ...
                messagebox.showerror("OpenPicoKeys", payload)
            elif kind == "success":
                self.status_var.set(payload)
            elif kind == "done":
